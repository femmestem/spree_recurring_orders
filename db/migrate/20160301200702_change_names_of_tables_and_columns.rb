class ChangeNamesOfTablesAndColumns < ActiveRecord::Migration
  def up
    ...
    change_column_null :spree_subscription_frequencies, :string, false
    change_column :spree_subscriptions, :last_occurrence_at, :datetime
    change_column :spree_subscriptions, :end_date, :datetime
    change_column :spree_subscriptions, :cancelled_at, :datetime
    change_column :spree_orders_subscriptions, :failed_at, :datetime
  end
